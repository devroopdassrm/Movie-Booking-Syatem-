...
void reservation(int *array,int price,int slection)
{
		...
		if (j>100||j<1)
			{
				printf("Seat 1 number is unavailable in this theater\n");
...
int choice1(void)
{
	...
	printf(" ==================================================================\n");
	printf("||             1- To edit price of ticket (For Admin):           ||\n");
	printf("||             2- To view reserved tickets (For Admin):          ||\n");
...
void ticket1(int choice,char name[10],int id2,int price)
{
        ...
        printf("\t============================================================\n");
        printf("\t Booking ID : %d \t\t\tShow Name : The Dark Knight\n",id2);
        printf("\t Customer  : %s\n",name);
...
int movie(void)
{
	...
	printf("\t\t\t----------------------------\n\n");
	printf("\t\t\tPress 1 for The Dark Knight\n\n");
	printf("\t\t\tPress 2 for The Social Network\n\n");
	printf("\t\t\tPress 3 for Mulholland Drive\n");
	scanf("%d",&i);
	system("cls");
	return i;
}
void ticket2(int choice,char name[10],int id2,int price)
{
        ...
        printf("\t-----------------THEATER BOOKING TICKET----------------\n");
        printf("\t============================================================\n");
        printf("\t Booking ID : %d \t\t\tShow Name : The Social Network\n",id2);
        printf("\t Customer  : %s\n",name);
...
void ticket3(int choice,char name[10],int id2,int price)
{
        ...
        printf("\t-----------------THEATER BOOKING TICKET----------------\n");
        printf("\t============================================================\n");
        printf("\t Booking ID : %d \t\t\tShow Name : Mulholland Drive \n",id2);
        printf("\t Customer  : %s\n",name);
